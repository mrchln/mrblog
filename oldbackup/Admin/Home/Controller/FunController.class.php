...
class FunController extends Controller {
    ...
    ##一个查询方法
    ##
    public function seach($db,$num,$page_header,$order,$where,$where2){
        $this->valid();
        $count = $db->where($where)->where($where2)->count();// 
    ...
    public function encryption($str){
        $pwd=md5(md5($str)."eb03f6c72908fd84");
        return $pwd;
    }
