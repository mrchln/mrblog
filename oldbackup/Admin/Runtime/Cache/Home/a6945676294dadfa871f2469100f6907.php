...
<div class="panel">
	...
	<div class="panel-body">
		...
		<div class="table">
			<table cellspacing="0" class="table table-bordered">
				...
				<?php if(is_array($selectArticle)): foreach($selectArticle as $key=>$sel): ?><tr>
						...
						<td>
							...
							<a href="/MrLingBlog/admin.php/home/index/editorUser?id=<?php echo ($sel["id"]); ?>" data-type="iframe" data-toggle="modal" class="btn btn-primary"> <i class="icon-edit"></i>
								编辑
							</a>
						...
						<td>
							<a href="/MrLingBlog/admin.php/home/index/delUser?id=<?php echo ($sel["id"]); ?>" onclick="return delsure(this)"  class="btn btn-danger"><i class="icon-remove"></i>删除</a>
						</td>
			...
			<br/>
			<a href="/MrLingBlog/admin.php/home/index/addUser" data-type="iframe" data-toggle="modal" class="btn btn-success">
