...
<?php if(is_array($select)): $i = 0; $__LIST__ = $select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sel): $mod = ($i % 2 );++$i;?><br/>
	<div class="input-group">
		<span class="input-group-btn">
			<button class="btn btn-default" type="button">邻居：</button>
		</span>

		<input class="form-control" type="text" value="<?php echo ($sel['nearly']); ?>" name="name" placeholder='' autofocus/>
	...
	<div class="input-group">
		...
		<input class="form-control" type="text" value="<?php echo ($sel['message']); ?>" name="msg" placeholder='' />
	</div>
	...
	<div class="input-group">
		...
		<input class="form-control" type="text" value="<?php echo ($sel['link']); ?>" name="lin" placeholder='http://' />
	...
	<div class="input-group">
		...
		<input class="form-control" type="text" value="<?php echo ($sel['logo']); ?>" name="log" placeholder='http://' />
