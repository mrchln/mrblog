...
<form method="post">
	<div class="panel">
		<div class="panel-heading">历程添加</div>
		<div class="panel-body">
			...
			<div class="col-xs-3">
				<div class="input-group">
					...
					<input name="tim" type="text" class="form-control form-date" placeholder="选择或者输入一个日期：yyyy-MM-dd" value="<?php echo ($map['time']); ?>" required></div>
			</div>
			<br/>
			<br/>
			<div class="col-xs-3">
...
<div id="seach">
	<div class="panel">
		<div class="panel-heading">历程管理</div>
		<div class="panel-body">
			<form method="post">
				<div class="col-xs-3">
					<div class="input-group">
