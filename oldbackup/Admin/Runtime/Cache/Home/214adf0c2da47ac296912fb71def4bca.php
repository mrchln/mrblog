	...
	<div class="panel">
		...
		<div class="panel-body">
			<?php if(is_array($class)): foreach($class as $key=>$clas): ?><div class="tag">
					<a href="/oldbackup/admin.php/Home/Index/adminArticle/ename/<?php echo ($clas["ename"]); ?>">
		...
		<table cellspacing="0" class="table table-bordered">
			...
			<tbody>
				<?php if(is_array($selectArticle)): foreach($selectArticle as $key=>$sel): ?><tr>
						...
						<td>
							<a href="/oldbackup/mood/detailed/id/<?php echo ($sel["id"]); ?>" target="bank" title='跳转到该文章'><?php echo ($sel["title"]); ?></a>
						</td>
						<form method="post" >
							<td>
						...
						<form method="post" >
							<td>
								<input class="btn btn-default" type="submit" name="month" value="<?php echo ($sel["now"]); ?>" title='按月查询' />
							</td>
						</form>
						<form method="post" name="" action="/oldbackup/admin.php/Home/Index/addArticle">
							<td>

								<a href="/oldbackup/admin.php/Home/Index/addArticle?id=<?php echo ($sel["id"]); ?>" data-type="iframe" data-toggle="modal" class="btn btn-primary"> <i class="icon-edit"></i>
									编辑
								</a>
							</form>
						</td>
						...
						<td>
						<form method="post" name="" action="/oldbackup/admin.php/Home/Index/del">
							
											
											<a href="/oldbackup/admin.php/Home/Index/del?id=<?php echo ($sel["id"]); ?>" onclick="return delsure(this)"  class="btn btn-danger"><i class="icon-remove"></i>删除</a>
